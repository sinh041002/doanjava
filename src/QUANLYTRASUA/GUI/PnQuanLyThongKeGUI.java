...
import QUANLYTRASUA.BUS.ThongKeBUS;
import QUANLYTRASUA.DTO.ThongKe;
...
public class PnQuanLyThongKeGUI extends JPanel {
    ...
    final Color colorPanel = new Color(8, 8, 8);
...
//        pnThongKeTong.add(btn_filter);
        ...
        //              THỐNG KÊ CHI TIẾT
        // ==============================================
        pnThongKeChiTiet = new Transparent(null);
