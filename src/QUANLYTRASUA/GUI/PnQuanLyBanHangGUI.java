package QUANLYTRASUA.GUI;

import QUANLYTRASUA.DTO.LoaiSP;
import QUANLYTRASUA.DTO.HoaDon;
import QUANLYTRASUA.DTO.SanPham;
import QUANLYTRASUA.DTO.CTHoaDon;
import QUANLYTRASUA.DTO.NhanVien;
import QUANLYTRASUA.BUS.LoaiBUS;
import QUANLYTRASUA.BUS.NhanVienBUS;
import QUANLYTRASUA.BUS.HoaDonBUS;
import QUANLYTRASUA.BUS.CTHoaDonBUS;
import QUANLYTRASUA.BUS.DangNhapBUS;
import QUANLYTRASUA.BUS.SanPhamBUS;

import static Main.Main.changLNF;

import MyCustom.Dialog;
import MyCustom.Table;
import MyCustom.Transparent;
...
public class PnQuanLyBanHangGUI extends JPanel {
    ...
    private void addControlsBanHang() {
        ...
        JPanel pnTableBanHang = new Transparent();
        pnTableBanHang.setLayout(new BorderLayout());

        JPanel pnTitleBanHang = new Transparent();
        ...
        //====================Thông tin giỏ hàng====================
        JPanel pnTableGioHang = new Transparent();
        ...
        //====================Thông tin bán hàng====================
        JPanel pnThongTinBanHang = new Transparent();
        ...
        JPanel pnTitleThongTin = new Transparent();
        ...
        JPanel pnLoaiSP = new Transparent();
        ...
        JPanel pnTenSP = new Transparent();
        ...
        JPanel pnDonGiaSP = new Transparent();
        ...
        JPanel pnSoLuongSP = new Transparent();
        ...
        JPanel pnNhanVienBan = new Transparent();
        ...
        JPanel pnButtonBan = new Transparent();
        ...
        JPanel pnAnhSanPham = new Transparent();
        ...
        JPanel pnButtonBanHang = new Transparent();
        ...
        //</editor-fold>
        //=======================================================
        JPanel pnCenter = new Transparent();

        JPanel pnLeftBanHang = new Transparent();
        ...
        JPanel pnRightBanHang = new Transparent();
        ...
        JPanel pnCTBanHang = new Transparent();
        ...
        JPanel pnCTHoaDonLeft = new Transparent();
        ...
        JPanel pnTitleHoaDon = new Transparent(new FlowLayout());
        ...
        JPanel pnMaHD = new Transparent(new FlowLayout());
        pnMaHD.add(lblMaHD);
        ...
        JPanel pnMaKH = new Transparent(new FlowLayout());
        pnMaKH.add(lblMaKH);
        ...
        JPanel pnMaNV = new Transparent(new FlowLayout());
        pnMaNV.add(lblMaNV);
        ...
        JPanel pnNgayLap = new Transparent(new FlowLayout());
        ...
        JPanel pnTongTien = new Transparent(new FlowLayout());
        ...
        JPanel pnGhiChu = new Transparent(new FlowLayout());
        ...
        JPanel pnSearchPrice = new Transparent(new FlowLayout());
        ...
        JPanel pnSearchDate = new Transparent(new FlowLayout());
        ...
        JPanel pnListHoaDon = new Transparent();
        ...
        //=======================================================
        JPanel pnCTHoaDonRight = new Transparent();
        pnCTHoaDonRight.setLayout(new BorderLayout());

        JPanel pnTopCTHoaDonRight = new Transparent();
        ...
        JPanel pnTitleCT = new Transparent();
        ...
        JPanel pnMaHDCT = new Transparent();
        ...
        JPanel pnMaSPCT = new Transparent();
        ...
        JPanel pnSoLuongCT = new Transparent();
        ...
        JPanel pnDonGiaCT = new Transparent();
        ...
        JPanel pnThanhTienCT = new Transparent();
