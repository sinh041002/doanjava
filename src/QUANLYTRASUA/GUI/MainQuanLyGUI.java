...
public class MainQuanLyGUI extends JFrame {
    ...
    public MainQuanLyGUI() {
        this.setTitle("QUẢN LÝ CỬA HÀNG TRÀ SỮA");
    ...
    final Color clLeftItem = new Color(8,8,8);
    final Color clLeftItemHover = new Color(222, 184, 135);
    final Color clLeftItemSelected = new Color(139, 71, 38);
    ...
    private void addControls() {
        ...
        pnTitle.setBackground(new Color(8,8,8));
