...
import QUANLYTRASUA.BUS.PhanQuyenBUS;
import QUANLYTRASUA.BUS.TaiKhoanBUS;
import QUANLYTRASUA.DTO.NhanVien;
import QUANLYTRASUA.DTO.PhanQuyen;
...
public class PnQuanLyNhanVienGUI extends JPanel {
    ...
    private void addControlsNhanVien() {
        ...
        JPanel pnMa = new Transparent();
        pnMa.add(lblMa);
        pnMa.add(txtMaNV);
        pnText.add(pnMa);

        JPanel pnHo = new Transparent();
        pnHo.add(lblHo);
        pnHo.add(txtHo);
        pnText.add(pnHo);

        JPanel pnTen = new Transparent();
        pnTen.add(lblTen);
        pnTen.add(txtTen);
        pnText.add(pnTen);

        JPanel pnGioiTinh = new Transparent();
        pnGioiTinh.add(lblGioiTinh);
        pnGioiTinh.add(cmbGioiTinh);
        pnText.add(pnGioiTinh);

        JPanel pnChucVu = new Transparent();
        ...
        //==========
        JPanel pnTimNV = new Transparent();
        ...
        //==========
        JPanel pnButton = new Transparent();
        ...
        JPanel pnButton2 = new Transparent();
        ...
        //===================TABLE NHÂN VIÊN=====================
        JPanel pnTableNhanVien = new Transparent();
        ...
        =========================================================================
         */
        JPanel pnPhanQuyen = new Transparent();
        pnPhanQuyen.setLayout(new BoxLayout(pnPhanQuyen, BoxLayout.Y_AXIS));

        JPanel pnTitlePhanQuyen = new Transparent();
        ...
        JPanel pnCmbQuyen = new Transparent();
        ...
        JPanel pnCheckNhapHang = new Transparent();
        ...
        JPanel pnCheckQLSanPham = new Transparent();
        ...
        JPanel pnCheckQLNhanVien = new Transparent();
        ...
        JPanel pnCheckQLKhachHang = new Transparent();
        ...
        JPanel pnCheckQLThongKe = new Transparent();
        ...
        JPanel pnButtonQuyen = new Transparent();
